...
public class Moments {
        ...
        public static Point getRawCentroid(double[][] img) {
            ...
            /* return centroid
               mrobbeloth modficiation: since the y axis is reflected
               horizontally over x, we need to swap xbar and ybar 
               to match Matlab, this is not a standard 2D Cartisean 
               plane that we are working to get momemnts from
               Point p = new Point(xbar, ybar); */
            Point p = new Point(ybar, xbar);
            return p;
        }
