...
<head>
  ...
  <title>./obstruction Database</title>
...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="index.html" class="navbar-brand"><b>./obstruction</b> Database</a>
	  ...
	  <div class="row">
		<div class="col-md-6"> <!-- Implied Relationship -->
			<div class="box box-success">
				...
				<div class="box-body">
					<table id="implied_constraints" class="table table-bordered table-striped dataTable" role="grid">
					<thead align='left'>
					<tr>
					  <th>Child Column</th>					  
					...
					<tbody>
									<tr><td colspan="3">Anomaly not detected</td></tr>
									</tbody>
					</table>				
				</div>
			</div>	
		...
		<div class="col-md-6"> <!-- Tables without indexes -->
			<div class="box box-danger">
				...
				<div class="box-body">
					<table id="un_indexed_tables" class="table table-bordered table-striped dataTable" role="grid">
					<thead align='left'>
					<tr>
					  <th>Table</th>
					  <th>Rows</th>		
  ...
  <footer class="main-footer">
    <div>
      ...
      <strong>Generate by <a href="http://schemaspy.org/" class="logo-text"><i class="fa fa-database"></i> SchemeSpy 6.0.0-beta.3</a></strong>
    </div>
    <!-- /.container -->
  </footer>
</div>
